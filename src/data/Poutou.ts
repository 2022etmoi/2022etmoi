...
export const Poutou = new Candidate(
    ...
    new Map([
        ...
        [PropositionID.EXPROPRIER_CAPITALISTES, new Answer(CandidateAnswer.YES, "\"Expropriation des grandes entreprises, à commencer par l‘industrie pharmaceutique et l’énergie\"")],
