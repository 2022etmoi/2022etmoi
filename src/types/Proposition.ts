...
export enum PropositionID {
    ...
    EXPROPRIER_CAPITALISTES = "EXPROPRIER_CAPITALISTES",
    EXPULSER_CHOMAGE = "EXPULSER_CHOMAGE",
    NUCLEAIRE = "NUCLEAIRE",
    ...
    RIC = "RIC",
    RSA_CONDITIONNE = "RSA_CONDITIONNE",
    RETRAITE_REPORTER = "RETRAITE_REPORTER",
    SMIC = "SMIC",
    ...
    TVA = "TVA",
    VEGETALISER = "VEGETALISER",
    VOILE_REGLEMENTER = "VOILE_REGLEMENTER",
}
